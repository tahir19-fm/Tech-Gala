...
class ParentItemAdapter internal constructor(private val itemList: List<EventDataModel>) :
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ParentViewHolder {
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.event_list_card_view, viewGroup, false)
    ...
    inner class ParentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            headingPost = itemView.findViewById(R.id.headingText)
